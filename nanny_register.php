...
<head>
    ...
    <style>
        ...
        form {
            ...
            background-color: rgba(255, 253, 208, 0.7); /* 70% opacity */
            margin: 50px auto;
            padding: 20px;
...
<body>
    ...
    <form action="uploadNanny.php" method="post" enctype="multipart/form-data">
        ...
        <label for="NannyName">保母名字:<span class="required">*</span></label>
        <input type="text" name="NannyName" id="NannyName" required>
...
<label for="secret_question">密碼提示問題 : <span class="error">*</span></label>
  ...
  <input type="text" name="secret_answer" id="secret_answer" maxlength="50" required>
    ...
    <label>上班的分店: <span class="error">*</span></label>
    <select name="work_at_branch" required class="branch-select">
        <option value="">-- 選擇你上班的分店 --</option>
        <?php
